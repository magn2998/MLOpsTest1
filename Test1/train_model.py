...
checkpoint_callback = ModelCheckpoint(
    dirpath="./models", monitor="val_accuracy", mode="max", filename="LightningTrainedModel.pt", save_on_train_epoch_end=True
)

wandb_logger = WandbLogger(name="My_Model", project="My_Project")

trainer = Trainer(callbacks=[checkpoint_callback], max_epochs=10, logger=wandb_logger)
